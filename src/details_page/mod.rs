...
use crate::{window::Window, note_object::NoteObject};
...
impl DetailsPage {
    ...
    pub fn setup(&self, window: &Window, note: &mut NoteObject) {
        ...
        self.imp().delete_button.connect_clicked(clone!(@weak window=>move|_btn|{
        ...
        self.imp().edit_button.connect_clicked(clone!(@weak window, @weak save_btn, @weak cancel_btn, @weak text_view=>move|btn|{
            // window.delete_note(id);
        ...
        self.imp().cancel_button.connect_clicked(clone!(@weak window, @weak save_btn, @weak edit_button, @weak text_view=>move|btn|{
            // window.delete_note(id);
            // btn.set_visible(false);
        ...
        self.imp().save_button.connect_clicked(clone!(@weak window, @weak text_view=>move|_btn|{
